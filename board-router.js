(async () => {
  ...
  try {
    ...
    sessionStorage.setItem('visuplanner-board-route', JSON.stringify({ path, kind:result.kind, target_slug:result.target_slug, customer_slug:parts[0], board_slug:parts[1] }));
